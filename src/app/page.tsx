...
export default function Main() {
  ...
  const items = [
    {title: "Twitter insult detector", date: "01/10/2022", image: "", body: "Development of a website dashboard tracking tweets including insults. Creation of a data pipeline using Twitter API and Pandas. Insults retrieved via Twitter API. Data processing and analysis using a Random Forest algorithm (AI) and a list of keywords.", tags: ["Python", "Pandas", "Plotly & Dash"]},
    ...
    {title: "Movie Streaming Platform", date: "01/06/2023", image: "", body: "Development over 1 week of a user-friendly website interface, similar to Netflix, to make user-defined recommendations on what movie they could like.", tags: ["JS", "React", "Express"]},
    ...
    {title: "Prototyping of an IOS audio Companion", date: "01/02/2024", image: "/ProjectsImages/Sencial.jpg", body: "Development of an IOS companion app for hearing impaired people using audio modulation and AI. Our app retrieve audio data and audiograms from Apple Health app, and can also create audiograms with an experimental method. Our app is able to modulate more than 10 frequencies of the environnment around in real time you while you're listenting to your music or talking to a colleague. This audio modulation can be personalized based on your imported or created audiogram.", tags: ["Swift", "AVAudioEngine"]},
    {title: "Prototyping of tax credit file Companion", date: "01/04/2024", image: "/ProjectsImages/eliccir.jpg", body: "Developement of a tax credit file companion using data parsing and AI.", tags: ["Python", "TGI", "Langchain"]},
    {title: "Drone race leaderboard", date: "01/03/2024", image: "/ProjectsImages/leaderboard.jpg", body: "Development of a leaderboard for drone races. This leaderboard includes the ability to add participants, and to get their time with numerical chronometers. A live leaderboard displays each player ranking and time.", tags: ["JS", "Electron"]},
    {title: "Betting bot for Telegram", date: "01/05/2024", image: "", body: "Creation of a Telegram bot, which can advice betting players how to convert their 'freebet' money into real one with combined bets.", tags: ["Python", "BeautifulSoup"]},
    {title: "A/B Testing Platform", date: "15/06/2024", body: "Development of an A/B Testing platform using a complex pipeline. The plateform should massively test virtual user profiles and provide detailed metrics in order to choose the best coach.", image: "", tags: ["Docker", "Kubernetes", "Helm", "RabbitMQ", "Go"]},
  ]

const bio = "I am a Master student at CentraleSupelec, 2nd highly selective Engineering french school and 16th Engineering school worldwide."
+ " I am curious, hard-working, and particularly motivated by the subjects I am passionate about: computer science, maths, physics."
...
const education = [
  {title: "CentraleSupélec", time_period: "2022-2026", institution: "Master of Engineering", description: "Coursework:"
  ...
  {title: "Collège Stanislas Paris", time_period: "2020-2022", institution: "Preparation courses", 
    description: "I followed an intensive two-year preparation in Mathematics, Computer Science, Physics,"
    + "Engineering & Chemistry for the highly selective French School of Engineering. This is equivalent to a bachelor in engineering,"
    + "with a major in math and computer science"},
] 

const experiences = [
  {title: "Data Engineer", time_period: "Fall 2024", institution: "Forvis Mazars", description: "Data Engineering in Data Services team of Forvis Mazars. Working on applied and R&D projects."},
